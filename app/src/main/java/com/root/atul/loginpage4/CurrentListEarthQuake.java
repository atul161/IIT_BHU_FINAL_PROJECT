...
public class CurrentListEarthQuake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_list_earth_quake);
        ...
        databaseReference1.child("Earthquake").child("MP").setValue("MP");
       databaseReference1.child("Earthquake").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
                Intent intent=new Intent(CurrentListEarthQuake.this,EffectedPeopleListEarthQuake.class);
