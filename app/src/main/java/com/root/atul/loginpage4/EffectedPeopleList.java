...
public class EffectedPeopleList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_effected_people_list);
        ...
        listView=(ListView)findViewById(R.id.listview_flood_people);
        ...
        databaseReference.child("FLOOD").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren())
                {
                    ...
                    //Toast.makeText(EffectedPeopleList.this,s1,Toast.LENGTH_SHORT).show();
                    if(i%4==1)
                    {
                        save=s1;
                    }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
                Intent intent=new Intent(EffectedPeopleList.this,MessagesSend.class);
                intent.putExtra("Contact No",""+al.get(i));
                intent.putExtra("Name",""+alname.get(i));
                Toast.makeText(EffectedPeopleList.this, ""+"item"+i+"selected", Toast.LENGTH_SHORT).show();
